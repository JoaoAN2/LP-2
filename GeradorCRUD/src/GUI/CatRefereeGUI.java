...
import Controles.CatRefereeControle;
...
public class CatRefereeGUI extends JDialog {
    ...
    String path = "catReferee.csv";

    CatReferee catReferee = new CatReferee();
    CatRefereeControle CatRefereeControle = new CatRefereeControle();
    ...
    public CatRefereeGUI() {
        ...
        CatRefereeControle.loadData(path);

        btnSearch.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                cardLayout.show(pnSouth, "warning");
                catReferee = CatRefereeControle.read(tfSiglaCatReferee.getText());
                if (catReferee != null) {
                    btnCreate.setVisible(false);
       ...
       btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if("create".equals(action)){
                    CatRefereeControle.create(catReferee);
                }

                if("update".equals(action)){
                    CatRefereeControle.update(catReferee, oldCatReferee);
                }
                ...
                CatRefereeControle.saveData(path);
       ...
       btnUpdate.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                btnCancel.setVisible(true);
                btnList.setVisible(false);
                btnUpdate.setVisible(false);                tfNameCatReferee.requestFocus();
       ...
       btnDelete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if(response == JOptionPane.YES_OPTION) {
                    CatRefereeControle.delete(catReferee);
                    CatRefereeControle.saveData(path);
                }
       ...
       btnList.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                List<CatReferee> catRefereeList = CatRefereeControle.list();
