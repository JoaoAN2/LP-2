...
class GeradorDeGUI {
    ...
    GeradorDeGUI(String className, List<String> atributos) {
        ...
        cg.add("public class " + className + "GUI extends JDialog {\n"
                ...
                + "    " + className + "Controle " + className + "Controle = new " + className + "Controle();\n"
        ...
        cg.add("        for (int i = 0; i < 5; i++) {\n"
                ...
                + "\n"
                + "        " + className + "Controle" + ".loadData(path);\n");
        ...
        switch (aux[0]) {
            ...
            case "int":
                ...
                break;
            default:
                cg.add("                " + classNameMin + " = " + className + "Controle.read(ErroDeTipagem.valueOf(tf" + stringTools.firstLetterToUpperCase(aux[1]) + "));");
        }
        ...
        cg.add("       btnSave.addActionListener(new ActionListener() {\n"
                + "            @Override\n"
                + "            public void actionPerformed(ActionEvent ae) {\n"
                + "                " + className + " old" + className + " = " + classNameMin + ";\n\n"
        ...
        for(int i = 0; i < atributos.size(); i++) {
            ...
            switch(aux[0]){
                ...
                case "double":
                    ...
                    break;
                default:
                    cg.add("                " + classNameMin + ".set" + stringTools.firstLetterToUpperCase(aux[1]) + "(DESCONHECIDO.valueOf(tf" + stringTools.firstLetterToUpperCase(aux[1]) + ".getText()));");
            }
        }
        
        cg.add("\n                if(\"create\".equals(action)){\n"
                + "                    " + className + "Controle.create(" + classNameMin + ");\n"
                + "                }");
        
        cg.add("\n                if(\"update\".equals(action)){\n"
                + "                    " + className + "Controle.update(" + classNameMin + ", old" + className + ");\n"
                + "                }\n");
        ...
        cg.add("                btnSearch.setVisible(true);\n"
                 ...
                 + "                clear();\n"
                 + "                disabled();\n\n"
                 + "                " + className + "Controle.saveData(path);\n"
        );
        ...
        cg.add("       btnDelete.addActionListener(new ActionListener() {\n"
                ...
                + "                    " + className + "Controle.delete(" + classNameMin + ");\n"
                + "                    " + className + "Controle.saveData(path);\n"
                + "                }\n"
        );
        ...
        cg.add("       btnList.addActionListener(new ActionListener() {\n"
                ...
                + "            public void actionPerformed(ActionEvent ae) {\n"
                + "\n"
                + "                List<" + className + "> " + classNameMin + "List = " + className + "Controle.list();\n"
